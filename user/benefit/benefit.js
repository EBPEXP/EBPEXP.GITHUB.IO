...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.querySelector(".sideHeadingBox:nth-of-type(1)").textContent =
    categoryOtherData[0].name;
  document
    .querySelector(".sideHeadingBox:nth-of-type(1)")
    .setAttribute(
      "href",
      `/user/benefit/benefit.html?id=${categoryOtherData[0].id}`
    );
  document.querySelector(".sideHeadingBox:nth-of-type(2)").textContent =
    categoryOtherData[1].name;
  document
    .querySelector(".sideHeadingBox:nth-of-type(2)")
    .setAttribute(
      "href",
