...
document
  .getElementById("deleteBenefit")
  .setAttribute(
    "href",
    `/admin/delete_benefit/delete_benefit_form.html?id=${id}`
  );
//setting link for add benefit button
document
  .getElementById("addBenefit")
  .setAttribute("href", `/admin/add_benefit/admin_add_benefit.html?id=${id}`);
